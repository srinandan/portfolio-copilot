...
PER_SKILL_TIMEOUT: dict[str, timedelta] = {
    ...
    "spending-analysis": timedelta(seconds=float(os.environ.get("SPENDING_ANALYSIS_TIMEOUT_SECONDS", "180"))),
    "private-spending-analysis": timedelta(seconds=float(os.environ.get("SPENDING_ANALYSIS_TIMEOUT_SECONDS", "180"))),
}
